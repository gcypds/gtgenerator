...
void
gtproj_ (::xercesc::XMLFormatTarget& ft,
         const ::gtproj& x, 
         const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
         const ::std::string& e = "UTF-8",
         ::xml_schema::flags f = 0);
...
gtproj_ (const ::gtproj& x, 
         const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
         ::xml_schema::flags f = 0);

void
operator<< (::xercesc::DOMElement&, const gtproj&);

void
operator<< (::xercesc::DOMElement&, const proj&);
